...
class wall():
    ...
    def create_wall(self):
        ...
        for row in range(rows):
            ...
            for col in range(cols):
                #generate x and y position for each block and create a rectangle for that
                ...
                #append that individual block in to block row
    ...
    def draw_wall(self):
        for row in self.blocks:
            for block in row :
                #assign the colour based on the strength 
                if block[1] == 3:
